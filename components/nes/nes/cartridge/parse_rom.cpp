...
static ROM_File* parseROM_iNES(const u8* data, uint32_t data_len) {
...
static ROMFileFormat::Type rom_type(const u8* data, uint32_t data_len) {
  (void)data_len;
...
ROM_File* parseROM(const u8* data, uint32_t data_len) {
